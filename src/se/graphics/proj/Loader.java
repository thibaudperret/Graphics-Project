...
public final class Loader {
    ...
    private static List<Item> loadItems() {
        ...
        // Left wall
        items.add(PhysicalObject.physicalRectangle(new Rectangle(A, E, C), Opaque.idealDiffuse(Color.SPRING_GREEN)));

        // Right wall
        items.add(PhysicalObject.physicalRectangle(new Rectangle(B, D, F), Opaque.idealDiffuse(Color.SALMON)));
        ...
        E = new Vector3(0.35f, -0.9999f, -0.9f);
        F = new Vector3(0.65f, -0.9999f, -0.9f);
        G = new Vector3(0.35f, -0.9999f, 0.5f);
        ...
        Lamp lamp2 = new DiffuseLamp(new Rectangle(E, F, G), Opaque.idealDiffuse(Color.WHITE), 14f, Color.WHITE);
        items.add(lamp2);
...
//        
//        // Front
//        items.add(PhysicalObject.physicalRectangle(new Rectangle(A, B, E), Opaque.idealDiffuse(Color.LIGHT_BLUE)));
//
//        // Left
//        items.add(PhysicalObject.physicalRectangle(new Rectangle(A, C, E), Opaque.idealDiffuse(Color.LIGHT_BLUE)));
//
//        // Right
//        items.add(PhysicalObject.physicalRectangle(new Rectangle(B, D, F), Opaque.idealDiffuse(Color.LIGHT_BLUE)));
//
//        // Back
//        items.add(PhysicalObject.physicalRectangle(new Rectangle(C, D, G), Opaque.idealDiffuse(Color.LIGHT_BLUE)));
//
//        // Top
//        items.add(PhysicalObject.physicalRectangle(new Rectangle(E, F, G), Opaque.idealDiffuse(Color.LIGHT_BLUE)));
...
//        // ------------------- BL2 -------------------
        ...
        // Front
        items.add(PhysicalObject.physicalRectangle(new Rectangle(A, B, E), Opaque.idealDiffuse(Color.WHITE)));

        // Left
        items.add(PhysicalObject.physicalRectangle(new Rectangle(A, C, E), Opaque.idealDiffuse(Color.WHITE)));

        // Right
        items.add(PhysicalObject.physicalRectangle(new Rectangle(B, D, F), Opaque.idealDiffuse(Color.WHITE)));
        ...
        items.add(PhysicalObject.physicalSphere(new Sphere(new Vector3(0.5f, 0.7f, 0.4f), 0.3f), Opaque.idealSpecular(Color.WHITE)));
//        items.add(PhysicalObject.physicalSphere(new Sphere(new Vector3(-0.5f, -0.1f, 0.4f), 0.4f), Opaque.idealDiffuse(Color.LIGHT_PURPLE)));
    ...
    private static List<Lamp> loadLightSources() {
        ...
        // ------------------- LIGHTS -------------------
        Vector3 E = new Vector3(0.35f, -0.9999f, -0.9f);
        Vector3 F = new Vector3(0.65f, -0.9999f, -0.9f);
        Vector3 G = new Vector3(0.35f, -0.9999f, 0.5f);
