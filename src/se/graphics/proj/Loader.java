...
public final class Loader {
    ...
    private static List<Lamp> lightSources = new ArrayList<Lamp>();
    ...
    static void loadItems() {
        ...
        // Left wall
        items.add(PhysicalObject.physicalTriangle(new Triangle(A, E, C), Opaque.idealDiffuse(Color.LIGHT_BLUE)));
        items.add(PhysicalObject.physicalTriangle(new Triangle(C, E, G), Opaque.idealDiffuse(Color.LIGHT_BLUE)));

        // Right wall
        items.add(PhysicalObject.physicalTriangle(new Triangle(F, B, D), Opaque.idealDiffuse(Color.LIGHT_PURPLE)));
        items.add(PhysicalObject.physicalTriangle(new Triangle(H, F, D), Opaque.idealDiffuse(Color.LIGHT_PURPLE)));
        ...
        // Lamp
        Lamp lamp1 = new DiffuseLamp(new Triangle(E.entrywiseDot(v), F.entrywiseDot(v), G.entrywiseDot(v)),Opaque.idealDiffuse(Color.WHITE), 1000f, Color.WHITE);
        Lamp lamp2 = new DiffuseLamp(new Triangle(F.entrywiseDot(v), H.entrywiseDot(v), G.entrywiseDot(v)),Opaque.idealDiffuse(Color.WHITE), 1000f, Color.WHITE);
        items.add(lamp1);
        ...
        // Back wall
        items.add(PhysicalObject.physicalTriangle(new Triangle(G, D, C), Opaque.idealDiffuse(Color.RED)));
        items.add(PhysicalObject.physicalTriangle(new Triangle(G, H, D), Opaque.idealDiffuse(Color.RED)));
        ...
        // Front
        items.add(PhysicalObject.physicalTriangle(new Triangle(E, B, A), Opaque.idealDiffuse(Color.WHITE)));
        items.add(PhysicalObject.physicalTriangle(new Triangle(E, F, B), Opaque.idealDiffuse(Color.WHITE)));

        // Front
        items.add(PhysicalObject.physicalTriangle(new Triangle(F, D, B), Opaque.idealDiffuse(Color.WHITE)));
        items.add(PhysicalObject.physicalTriangle(new Triangle(F, H, D), Opaque.idealDiffuse(Color.WHITE)));

        // Back
        items.add(PhysicalObject.physicalTriangle(new Triangle(H, C, D), Opaque.idealDiffuse(Color.WHITE)));
        items.add(PhysicalObject.physicalTriangle(new Triangle(H, G, C), Opaque.idealDiffuse(Color.WHITE)));

        // Left
        items.add(PhysicalObject.physicalTriangle(new Triangle(G, E, C), Opaque.idealDiffuse(Color.WHITE)));
        items.add(PhysicalObject.physicalTriangle(new Triangle(E, A, C), Opaque.idealDiffuse(Color.WHITE)));

        // Top
        items.add(PhysicalObject.physicalTriangle(new Triangle(G, F, E), Opaque.idealDiffuse(Color.WHITE)));
        items.add(PhysicalObject.physicalTriangle(new Triangle(G, H, F), Opaque.idealDiffuse(Color.WHITE)));
